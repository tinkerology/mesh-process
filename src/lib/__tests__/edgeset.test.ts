...
test('contains', () => {
    const mesh1 = MeshBuilder.buildCuboid(new Vertex(0,0,0), 10, 20, 30);
    const edgeset1 = new EdgeSet(MeshInfo.getEdges(mesh1));
    expect(edgeset1.contains(new Edge(new Vertex(0,0,0), new Vertex(10,0,0)))).toBe(true);
    expect(edgeset1.contains(new Edge(new Vertex(0,0,0), new Vertex(11,0,0)))).toBe(false);
});

test('remove', () => {
    const mesh1 = MeshBuilder.buildCuboid(new Vertex(0,0,0), 10, 20, 30);
    const edgeset1 = new EdgeSet(MeshInfo.getEdges(mesh1));
    expect(edgeset1.remove(new Edge(new Vertex(0,0,0), new Vertex(10,0,0)))).toBe(true);
    expect(edgeset1.remove(new Edge(new Vertex(0,0,0), new Vertex(11,0,0)))).toBe(false);
});

test('isConnectedTo', () => {
    const mesh1 = MeshBuilder.buildCuboid(new Vertex(0,0,0), 10, 20, 30);
    const edgeset1 = new EdgeSet(MeshInfo.getEdges(mesh1));
    expect(edgeset1.isConnectedTo(new Edge(new Vertex(10,0,0), new Vertex(10,20,0)))).toBe(true);
    expect(edgeset1.isConnectedTo(new Edge(new Vertex(11,0,0), new Vertex(11,20,0)))).toBe(false);
});
