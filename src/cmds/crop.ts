...
exports.command =
    'crop [location] [minx] [miny] [minz] [maxx] [maxy] [maxz] [infile] [outfile]';
...
exports.builder = {
    location: {
        ...
        default: 'inside',
        description:
            'Whether to save vertices inside the bounding box our outside',
    },
    minx: {
...
exports.handler = function (argv: any) {
    try {
        ...
        const location: number =
            argv.location == 'inside'
                ? MeshOperations.CROP_INSIDE
                : MeshOperations.CROP_OUTSIDE;
        const croppedMesh: MeshInterface = MeshOperations.crop(
            mesh,
            boundingBox
        ).meshes[location];
