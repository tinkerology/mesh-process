...
exports.desc =
    'Rotate the specified STL file by the specified degrees in X, Y, and Z';
exports.builder = {
    x: {
        default: 0,
...
exports.handler = function (argv: any) {
    try {
        ...
        const rotatedMesh: MeshInterface = MeshOperations.rotate(
            mesh,
            argv.x,
            argv.y,
            argv.z
        ...
        new STLFile().writeSTLFile(
            argv.outfile,
            'Rotate_' + argv.x + '_' + argv.y + '_' + argv.z,
            rotatedMesh
        );
    } catch (e) {
